...
import com.jpp.mall.adapter.SellerOrderAdapterRv4;
...
public class SellerOrderFourFragment extends Fragment implements SellerOrderAdapterRv4.OnItemClickListener {
    private static final String TAG = "SellerOrderFourFragment";
    @BindView(R.id.seller_order_rv)
    RecyclerView sellerOrderRv;

    private List<SellerOrder.Data> sellerOrders = new ArrayList<>();
    private SellerOrderAdapterRv4 sellerOrderAdapter;
    ...
    private void initData() {
        ...
        sellerOrderAdapter = new SellerOrderAdapterRv4(sellerOrders,getActivity());
