...
public class ChildAdapter extends RecyclerView.Adapter<ChildChildVolder> {
    ...
    public ChildAdapter(List<DetailModel.AttrName> datas, Context context) {
        this.datas = datas;
...
//        holder.rootView.setBackground(context.getResources().getDrawable(icons[position]));
        ...
        holder.itemContent.setText(datas.get(position).attrValues.get(0).name);
