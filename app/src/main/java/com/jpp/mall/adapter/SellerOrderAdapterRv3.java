...
import com.jpp.mall.holder.OrderRvHolder3;
...
public class SellerOrderAdapterRv3 extends RecyclerView.Adapter<OrderRvHolder3> {
    private List<SellerOrder.Data> datas;
    private Context context;
    private int pos;

    public SellerOrderAdapterRv3(List<SellerOrder.Data> datas, Context context) {
        this.datas = datas;
        this.context = context;
    }

    @Override
    public OrderRvHolder3 onCreateViewHolder(ViewGroup parent, int viewType) {
        View   view = LayoutInflater.from(context).inflate(R.layout.item_seller_order3, parent, false);
        OrderRvHolder3 volder = new OrderRvHolder3(view);
        return volder;
    }

    @Override
    public void onBindViewHolder(final OrderRvHolder3 holder, final int position) {
...
//        holder.shop_name.setText("" + datas.get(position).details.);
        ...
        holder.sureRecept.setOnClickListener(new View.OnClickListener() {
            @Override
