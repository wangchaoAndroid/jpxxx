...
public class SellerOrderHolder4 extends RecyclerView.ViewHolder {
    public  View rootView;
    public TextView good_name,good_price,good_desc,good_color,good_num;
    private ImageView good_img;
    public SellerOrderHolder4(View itemView) {
        super(itemView);
        rootView = itemView;
