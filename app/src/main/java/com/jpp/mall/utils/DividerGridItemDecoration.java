...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration
{
    ...
    public DividerGridItemDecoration(Context context, int orientation, View ItemDecorationView) {
        ...
        if(ItemDecorationView == null || ItemDecorationView.getLayoutParams() == null){
            ...
            ItemDecorationView.setLayoutParams(new ViewGroup.LayoutParams(20,20));
            ItemDecorationView.setBackgroundColor(context.getResources().getColor(R.color.color_white));
        }
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent)
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            final int right = child.getRight() + params.rightMargin+ ItemDecorationViewWidth;
    ...
    public void drawVertical(Canvas c, RecyclerView parent)
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            int right = child.getRight() + ItemDecorationViewWidth;
