package com.jpp.mall.view.citypickerview.style.citypickerview;
...
import com.jpp.mall.view.citypickerview.citywheel.CityParseHelper;
import com.jpp.mall.view.citypickerview.style.citypickerview.widget.CanShow;
import com.jpp.mall.view.citypickerview.style.citypickerview.widget.wheel.OnWheelChangedListener;
import com.jpp.mall.view.citypickerview.style.citypickerview.widget.wheel.WheelView;
import com.jpp.mall.view.citypickerview.style.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
import com.jpp.mall.view.citypickerview.utils.utils;
...
public class CityPickerView implements CanShow, OnWheelChangedListener {
     ...
     * 初始化，默认解析城市数据，提交加载速度
     */
    public void init(Context context, List<CityModel.Data> cityModels) {
        this.context = context;
        parseHelper = new CityParseHelper();
        
        //解析初始数据
        if (parseHelper.getProvinceBeanArrayList().isEmpty()) {
            parseHelper.initData(context,cityModels);
        }
